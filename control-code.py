...
# 5 баллов.
# Скачать архив страниц интернет-сайта с тайско-английским словарём.
# Извлечь с каждой страницы пары "тайское слово — английское слово"
# и поместить их в питоновскую структуру данных типа "словарь", где ключом будет тайское слово, а значением — английское.
def make_dict():
    thai_dict = {}
    thai_reg = re.compile(
        "<tr><td class=th><a (?:.*?)>(.*?)</a></td><td>(?:.*?)</td><td class=pos>(?:.+?)</td><td>(.*?)</td></tr>")
...
# 8 баллов. Использовать структуру данных из предыдущего задания, записать её в файл формата json на диск,
# а также создать ещё одну структуру данных, где будет наоборот: английское слово ключ, а значение — массив тайских.
...
# 10 баллов. Создать на фласке веб-приложение "Англо-тайский словарь",
# где можно было бы в текстовом поле ввести английское слово и получить в качестве результата запроса — его перевод на тайский.
